    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surname', models.CharField(blank=True, max_length=200, null=True, verbose_name='отчествоо')),
                ('telegram_chat_id', models.CharField(blank=True, max_length=255, null=True, verbose_name='Поле для хранения идентификатора чата в Telegram')),
